...
export BUILD_SHARED_LIBRARY=(nvcc -std=c++11 -t 12 -Xcompiler -fPIC -Xcompiler "-DVERSION_INFO=$CUDA_VERSION" -Iinclude src/cuda-kernels/*.cu --shared -o build/awkward_cuda_kernels/libawkward-cuda-kernels.so)
